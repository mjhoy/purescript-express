...
getProp :: forall e a. (Decode a) => String -> HandlerM (express :: EXPRESS | e) (Either MultipleErrors a)
getProp k = HandlerM \req _ _ ->
    liftEff $ liftM1 (runExcept <<< decode) (runFn2 _getProp req k)
